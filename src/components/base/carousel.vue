<template>
    ...
    <el-carousel trigger="click" height="450px" interval=10000>
  ...
  export default {
    ...
    data() {
      return {
        ...
        dataimg: [{
            src: require('../../../static/images/pic_business_4.jpg'),
          ...
          {
            src: require('../../../static/images/pic_business_3.jpg'),
          ...
          {
            src: require('../../../static/images/pic_blog_post_1.jpg'),
